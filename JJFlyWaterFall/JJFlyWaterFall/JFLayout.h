...
// copy from XRWaterFallLayout

#import <UIKit/UIKit.h>

@class JFLayout;
@protocol JFLayoutDelegate <NSObject>
...
@interface JFLayout : UICollectionViewLayout
...
//代理，用来计算item的高度
@property (nonatomic, weak) id<JFLayoutDelegate> delegate;
